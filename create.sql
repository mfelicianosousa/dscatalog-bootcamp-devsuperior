...
create table tb_user (id int8 generated by default as identity, keyword varchar(255), active varchar(255), date_expires timestamp, email varchar(255), first_name varchar(255), last_name varchar(255), login varchar(255), password varchar(255), status varchar(255), primary key (id));
